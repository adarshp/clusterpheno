...
The documentation source resides in the ``docs`` directory. The
command::

    make livehtml

generates HTML versions of the documentation that you can preview at 
http://127.0.0.1:8000. Once you are satisfied with the result, you can do::
  
  git add docs
  git commit -m 'docs updated' # Or a more detailed commit message
  git push

The online documentation will be automatically generated by `Read the Docs`_  
and will be available at http://exotichiggs.readthedocs.io within a minute.
For consistency, please use `Numpy-style docstrings`_ to document your classes,
